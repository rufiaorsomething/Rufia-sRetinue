...
extern MY_HIGHP_OR_MEDIUMP vec2 sundered_debuff;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
	...
	if (sundered_debuff.g > 0.0 || sundered_debuff.g < 0.0) {
		width = 0.1;
	}
	bool test = false;
