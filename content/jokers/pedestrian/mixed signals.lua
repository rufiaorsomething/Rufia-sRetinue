...
local function update_sprite(self, card)
	...
	if G.GAME.current_round.hands_left <= 1 then
		if card.ability.extra.current_mode == "green" or card.ability.extra.hands_played ~= G.GAME.current_round.hands_played then
			new_mode = "green"
	...
	card.ability.extra.hands_played = G.GAME.current_round.hands_played
